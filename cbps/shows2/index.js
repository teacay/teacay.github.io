(function($) {
  ...
  $.fn.gCalReader = function(options) {
    ...
    var feedUrl = 'https://www.googleapis.com/calendar/v3/calendars/' +
      ...
      '&orderBy=startTime&singleEvents=true&maxResults=3';
	...
	$($div).append('<li>' + eventdate2 + '</li><br><br>');
	 var eventdate3 = subtractOneDay(eventdate2);
	 	$($div).append('<li>' + eventdate3 + '</li><br><br>');
          ...
          var summary = item.summary || '';
					...
					s ='<div class="eventtitle"><a href="' + htmlLink +'" target="_blank">' + summary +'</a></div>';
					s +='<div class="eventdate">'+ eventDate + ' - ' +eventDate2 +'</div>';
					$($div).append('<li>' + s + '</li>');
        });}
      },
   ...
   //Subtract one day
    function subtractOneDay(dateInfo) {
      var date = formatDate(dateInfo, defaults.dateFormat.trim());
