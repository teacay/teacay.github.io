      ...
      success: function(data) {
        ...
        $.each(data.items, function(e, item) {
          ...
          var summary = item.summary || '';
					...
					var eventDate2 = formatDate(eventdate2, defaults2.dateFormat.trim());
					var htmlLink = item.htmlLink;
					s ='<div class="eventtitle"><a href="http://chinesebrushsd.blogspot.com/p/workshops.html" target="_top">' + summary +'</a></div>';
